...
/* ─── Rank Config ────────────────────────────────────── */
// bg/shadow use raw rgba because CSS vars can't be made transparent inline
const RC: Record<
  Rank,
  {
    color: string;
...
> = {
  S: {
    color: "var(--naruto_sage_red)", // #9B2230
  ...
  A: {
    color: "var(--sasuke_sharingan)", // #AF1313
  ...
  B: {
    color: "var(--naruto_collar)", // #082C8C
...
/*
 * RANKING RATIONALE:
 *   S — StoreIt (Next.js 15 + React 19 + Appwrite, production-grade storage)
 *       Creative Haven (PostGIS + Redis + TypeScript, complex arch)
 *   A — Wander Way (LLM integration), CineMetrics (data viz), Nxt Watch (full auth/playback)
 *   B — EBank (focused auth), StockPulse (dashboard tracker)
 *
 * TODO: Add `image` field per project when screenshots are ready:
 *   import projStoreit from "../assets/images/proj_storeit.png";
 *   Then replace <ImgPlaceholder /> with:
 *   <img src={projStoreit} alt="StoreIt" style={{ width:"100%", height:"100%", objectFit:"cover", borderRadius:"2px" }} />
 */
const projects: Project[] = [
  {
    ...
    description:
      "Production-grade Google Drive–like app enabling secure file upload, management, sharing, and real-time storage tracking — built on Next.js 15 & React 19 with a polished, fully responsive UI.",
    tech: [
      "Next.js 15",
      "React 19",
      "TypeScript",
  ...
  },
  {
    ...
    subtitle: "Privacy-First Creator Platform",
    description:
      "Pseudonymous social platform for creators to showcase work and collaborate locally — engineered with geospatial PostGIS queries, multi-layer Redis caching, and full TypeScript coverage.",
    tech: [
      "Next.js",
      "TypeScript",
      "Node.js",
  ...
  },
  {
    ...
    description:
      "AI-powered itinerary generator that creates personalized, budget-optimized travel plans with day-wise schedules and detailed cost breakdowns.",
  ...
  },
  {
    ...
    emoji: "🎬",
    title: "CineMetrics",
    subtitle: "Movie Analytics Engine",
    description:
      "Data-driven movie discovery platform that visualizes trends, ratings, and comparisons through interactive dashboards.",
    tech: ["React.js", "Node.js", "REST APIs", "Data Visualization"],
    github: "https://github.com/vishnusairam654/movie_app.git",
    live: "#",
    status: "complete",
    image: projCinemaetrics,
  },
  {
    rank: "A",
    emoji: "📺",
    ...
    description:
      "Full-featured YouTube-like app with authentication, video playback, trending feeds, and saved videos functionality.",
    tech: [
      "React.js",
      "Styled-Components",
      "React Router",
    ...
    github: "https://github.com/vishnusairam654/nxtwatch.git",
    live: "#",
    status: "complete",
    image: projNxtWatch,
  },
  {
    ...
    description:
      "Banking-style authentication system featuring JWT login, protected routes, and secure session management.",
  ...
  },
  {
    ...
    emoji: "📈",
    title: "StockPulse",
    subtitle: "Stock Tracking Dashboard",
    description:
      "Real-time stock market tracker with search, watchlist, and dynamic price visualization.",
    tech: ["Next.js", "React", "REST APIs", "TailwindCSS"],
    github: "#",
    live: "#",
    status: "complete",
    image: projStockPulse,
  },
];
...
const RankHeader = ({ rank, color }: { rank: Rank; color: string }) => (
  <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 4 }}>
    ...
    <Box
      sx={{ flex: 1, height: "1px", backgroundColor: color, opacity: 0.2 }}
    />
    <Box
      sx={{
        px: 1.5,
    ...
    <Slide direction="up" in={isVisible} timeout={900 + delay}>
      ...
      >
        ...
        >
          ...
          <Box
            sx={{
              ...
              border: `1px solid ${
                isComplete ? "var(--zoro_bandana)" : "var(--nami_hair)"
              }`,
              borderRadius: "4px",
              zIndex: 2,
            }}
          >
            ...
            >
              {isComplete ? "✓ MISSION COMPLETE" : "⌛ IN PROGRESS"}
            </Typography>
          </Box>

          {/* Polaroid frame (matches rest of portfolio) */}
          <Box
            sx={{
              width: "88%",
              height: { xs: 190, md: 290 },
              background: "#fff",
          ...
          >
            {/* TODO: Replace with actual screenshot import */}
            {proj.image ? (
              <img
                src={proj.image}
                alt={proj.title}
        ...
        >
          ...
          {/* Mission briefing with left border accent */}
          <Box
            sx={{
              mb: 3,
              pl: 2.5,
          ...
          <Stack direction="row" gap={2} flexWrap="wrap">
            <Box
              ...
              sx={{
                ...
                "&:hover": { transform: proj.github !== "#" ? "scale(1.05)" : "none", opacity: proj.github !== "#" ? 0.88 : 0.5 },
              }}
            >
              <FaGithub size={15} /> {proj.github !== "#" ? "SCROLL REPOSITORY" : "LOCKED"}
            </Box>
            {proj.live !== "#" && (
              <Box
                component="a"
              ...
              >
                <FaExternalLinkAlt size={13} /> LIVE MISSION
              </Box>
            )}
          </Stack>
        </Box>
          ...
          <Stack direction="row" gap={1.5}>
            <Box
              ...
              sx={{
                ...
                opacity: proj.github === "#" ? 0.5 : 1,
                pointerEvents: proj.github === "#" ? "none" : "auto",
                "&:hover": { transform: proj.github !== "#" ? "scale(1.05)" : "none" },
              }}
            >
...
/*
 * POSITIONING NOTE:
 *   This section naturally flows directly below the About overlays
 *   thanks to standard document flow!
 */
const Projects = () => {
  ...
  const filters: { key: FilterKey; label: string; color: string }[] = [
    { key: "ALL", label: "ALL MISSIONS", color: "var(--naruto_jumpsuit)" },
    { key: "S", label: "★★★ S-RANK", color: "var(--naruto_sage_red)" },
    { key: "A", label: "★★ A-RANK", color: "var(--sasuke_sharingan)" },
    { key: "B", label: "★ B-RANK", color: "var(--naruto_collar)" },
  ];
      ...
      >
        <Fade in={isVisible} timeout={800}>
          <Box>
            ...
            >
              Every mission logged. Every jutsu deployed. Every route charted.
            </Typography>
