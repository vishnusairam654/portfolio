...
// Importing a massive arsenal of icons from react-icons
import {
  SiReact,
  SiNextdotjs,
  SiTypescript,
...
const AboutMe = () => {
  const [ref, isVisible] = useOnScreen({ threshold: 0.1 }); // Lowered threshold since the component is taller
  ...
  // The Full Chakra Natures Arsenal
  const chakraNatures = [
    {
      title: "🔥 FIRE",
      subtitle: "FRONTEND",
    ...
    },
    {
      title: "⚡ LIGHTNING",
      subtitle: "LANGUAGES",
      color: "var(--sanji_hair)", // Using Sanji's yellow for lightning
      skills: [
    ...
    },
    {
      title: "🌊 WATER",
      subtitle: "BACKEND",
      color: "var(--nami_log_pose)", // Light blue
      skills: [
    ...
    {
      title: "🌿 WOOD",
      subtitle: "AI / ML & TOOLS",
      color: "var(--zoro_bandana)", // Green
      skills: [
  ...
  return (
    <>
      ...
      <Box
        ...
        sx={{
          ...
          "&::before": {
            ...
            height: "250px",
            background:
              "linear-gradient(to bottom, var(--naruto_jumpsuit), transparent)",
            pointerEvents: "none",
            zIndex: 0,
          },
        }}
              ...
              {aboutCollageImages.map((img, i) => (
                <Box
                  ...
                  sx={{
                    ...
                    boxShadow: (img as any).noFrame
                      ? "none !important"
                      : (img as any).shadow,
                    background: (img as any).noFrame
                      ? "transparent !important"
                      : undefined,
                    padding: (img as any).noFrame ? "0 !important" : undefined,
                    "& img": (img as any).noFrame
      ...
      {/* BOTTOM SECTION: CHAKRA NATURES (Full width grid) */}
      <Box
        sx={{
          position: "relative",
          width: "100vw",
          ...
          "&::before": {
            ...
            right: 0,
            height: "250px",
            background: "linear-gradient(to bottom, #FDF8F5, transparent)",
            pointerEvents: "none",
            zIndex: 0,
          },
          "&::after": {
            ...
            right: 0,
            height: "250px",
            background: "linear-gradient(to bottom, transparent, var(--hinata_jacket))",
            pointerEvents: "none",
            zIndex: 0,
          },
        }}
